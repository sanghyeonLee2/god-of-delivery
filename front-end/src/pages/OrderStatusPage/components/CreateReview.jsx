...
import {CommonSectionWrap, Font, VerticalSpace} from "../../../assets/styles/CommonStyle";
import {usePost} from "../../../hooks/usePost";
import useCreateReviewInitForm from "../../../hooks/useCreateReviewInitForm";

function CreateReview({orderId}) {
    const {register, watch, handleRatingChange, handleSubmit} = useCreateReviewInitForm(orderId);
